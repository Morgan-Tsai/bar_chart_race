...
fig.update_layout(
    title="<b>全球Covid-19確診人數變化(2020年1月~2023年3月)</b><br>(資料來源:CSSE at Johns Hopkins University)",
    title_font_size=25,
    title_x=0.5)
...
fig.update_layout(
    title="<b>全球Covid-19死亡人數變化(2020年1月~2023年3月)</b><br>(資料來源:CSSE at Johns Hopkins University)",
    title_font_size=25,
    title_x=0.5)
...
#covid-19 疫苗施打次數
early_doses = covid_19_doses[covid_19_doses["reported_on"] > "2020-11-30"]
print(early_doses.head())
doses_raceplot = barplot(early_doses,item_column="country",value_column="doses_administered",
                         time_column="reported_on")

fig = doses_raceplot.plot(item_label="Doses administered by country",value_label="Number of cases",frame_duration=50)

fig.update_layout(
    title="<b>全球Covid-19疫苗施打次數變化(2020年12月~2023年3月)</b><br>(資料來源:CSSE at Johns Hopkins University)",
    title_font_size=25,
    title_x=0.5)
